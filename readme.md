...
* `PATH` (`App.tsx`): **Tek müfredat yolu.** "Aşama 1/2/3" gruplandırması yoktur; alfabe (8) + dinleme konuları (100) + müfredat üniteleri (72) tek bir sıralı çizgi üzerinde **Ünite 1 → Ünite 180** olarak akar ve her kart bir önceki bitince açılır. Ön-hazırlık dinleme konuları, ilgili ünitenin **hemen öncesine** yerleştirilir. Haritadaki tüm kartlar aynı renkli ünite kartı tasarımını kullanır; seviye etiketleri (A1, A2, B1, B2, C1/C2) `LEVEL_COLORS` ile renklendirilir.
...
1. **🗺️ Öğrenme Yolu — Ünite 1'den 180'e Tek Sıra:** Haritada "Aşama 1/2/3" gruplandırması yoktur; alfabe üniteleri (1-8), harf/fonetik dinleme konuları (9-49) ve müfredat üniteleri + ön-hazırlık dinleme konuları (50-180) tek bir çizgi üzerinde sıralanır. Her kartın seviye etiketi (A1→C1/C2) ve renkli ikonu vardır; her kart bir önceki bitince açılır. Üstteki seviye çipleri (A1, A2, B1, B2, C1/C2) sizi yol içinde ilgili seviyenin ilk kartına kaydırır; **"🔊 Ses Testi"** butonu TTS sesinin çalıştığını anında doğrular.
...
3. **🎧 Kulağı Alıştır: 100 Dinleme Konusu (yolun içinde):** 33 harf + 8 fonetik konusu alfabe ünitelerinin hemen ardından; 59 müfredat ön-hazırlık konusu ilgili ünitenin hemen öncesine yerleşir. Cümle yoğunluğu düşüktür: her konu **kelime kartları odaklıdır** (tek tek 🔊 + seviye etiketli, en fazla 2 cümle + 2 diyalog satırı), "Konuyu Dinle" / "Yavaşça Dinle" TTS butonları ve 5 soruluk **"dinle & seç"** sınavıyla biter (son soru başka bir konudan gelir; geçersen kelimeler Aralıklı Tekrar havuzuna eklenir ve yoldaki sıradaki ünite açılır).
4. **📚 Müfredat Üniteleri (72 ünite, A1→C1/C2):** Kelime kartlarını çalışın, dilbilgisi açıklamalarını okuyun, dizi sahnelerini dinleyin ve kelime sıralama / cümle kurma / dinleme alıştırmalarını tamamlayın. Ünite bitiş sınavı geçilince (A2+ için hikaye Türkçeleştirme sınavında %85 barajıyla) yoldaki sıradaki kart açılır.
