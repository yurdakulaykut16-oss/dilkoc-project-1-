import type { AnswerEvaluation, FlashcardMode } from "./types";
...
export function evaluateAnswer(mode: FlashcardMode, expectedAnswer: string, userAnswer: string): AnswerEvaluation {
  ...
  if (mode === "sentence_building") {
    ...
    return {
      ...
      feedback: exact ? "Doğru cümle sırası." : sameWordsWrongOrder ? "Kelimeler doğru ama sıralama yanlış." : "Cümle hatalı.",
    };
  }
